...
2. **Diagnose**: orphans (no links either way) · dead links · unlinked mentions (a note's title/alias as plain text elsewhere) · tag drift (near-duplicates) · MOC coverage gaps · inbox backlog.
